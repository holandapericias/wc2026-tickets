...
export default function MarketClient({ tickets, summary }: { tickets: TicketWithSignal[]; summary: PortfolioSummary }) {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl font-bold">{t("marketOverview")}</h1>

      {/* Charts Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* P&L Waterfall */}
        <div className="bg-dark-card border border-dark-border rounded-lg p-4">
          <h3 className="text-sm font-semibold text-dark-muted uppercase mb-3">{t("portfolioPL")}</h3>
          <WaterfallChart
        ...
        <div className="bg-dark-card border border-dark-border rounded-lg p-4">
          <h3 className="text-sm font-semibold text-dark-muted uppercase mb-3">{t("multipleDistribution")}</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-dark-card border border-dark-border rounded-lg p-4">
          <h3 className="text-sm font-semibold text-dark-muted uppercase mb-3">{t("topPerformers")}</h3>
        ...
        <div className="bg-dark-card border border-dark-border rounded-lg p-4">
          <h3 className="text-sm font-semibold text-dark-muted uppercase mb-3">{t("underperformers")}</h3>
          <div className="space-y-2">
            {worst.map((t, i) => (
              <div key={t.id} className="flex items-center justify-between py-1 border-b border-dark-border last:border-0">
                <div className="flex items-center gap-2">
      ...
      <div className="bg-dark-card border border-dark-border rounded-lg p-4">
        <h3 className="text-sm font-semibold text-dark-muted uppercase mb-3">{t("portfolioProjection")}</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-dark-surface rounded-lg">
            <div className="text-xs text-dark-muted uppercase mb-1">{t("ifSoldToday")}</div>
          ...
          <div className="text-center p-4 bg-dark-surface rounded-lg">
            <div className="text-xs text-dark-muted uppercase mb-1">{t("in2Weeks")}</div>
          ...
          <div className="text-center p-4 bg-dark-surface rounded-lg">
            <div className="text-xs text-dark-muted uppercase mb-1">{t("atPeak")}</div>
      ...
      <div className="bg-dark-card border border-dark-border rounded-lg p-4">
        <h3 className="text-sm font-semibold text-dark-muted uppercase mb-3">{t("allTicketTrends")}</h3>
